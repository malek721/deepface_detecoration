...
def result():
    ...
    # تحليل الفيديو عند الوصول إلى صفحة النتائج
...
"""
        ...
        # إعدادات البريد
        sender_email = "malekco721@gmail.com"  # بريدك الحقيقي
        receiver_email = "mq7995154@gmail.com"
        app_password = "jlzb ulgx xtmo kdqs"  # كلمة مرور التطبيق

        msg = MIMEMultipart()
        msg['Subject'] = Header(f"Contact Form - {subject}", 'utf-8')
        msg['From'] = sender_email
        msg['To'] = receiver_email
        msg['Reply-To'] = user_email  # ← المهم هنا!
